...
if [ "$os" == "Debian" ] || [ "$os" == "Ubuntu" ]; then
 ...
 apt-get update
 apt-get install -y doxygen debhelper libpng-dev libjpeg-dev libindi-dev libnova-dev libfftw3-dev libcfitsio-dev cdbs cmake dpkg-dev build-essential fakeroot devscripts jq
