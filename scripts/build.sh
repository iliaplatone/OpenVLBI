...
if [ "$os" == "Debian" ] || [ "$os" == "Ubuntu" ]; then
 ...
 apt-get update
 apt-get install -y doxygen libindi-dev libnova-dev libfftw3-dev libjpeg-dev libpng-dev libcfitsio-dev cdbs cmake dpkg-dev build-essential fakeroot devscripts jq
