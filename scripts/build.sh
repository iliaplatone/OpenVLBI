...
if [ "$os" == "Debian" ] || [ "$os" == "Ubuntu" ]; then
 ...
 apt-get update
 apt-get install -y doxygen libindi-dev qt5-default libopencv-dev libnova-dev libfftw3-dev libcfitsio-dev cdbs cmake dpkg-dev build-essential fakeroot devscripts jq
