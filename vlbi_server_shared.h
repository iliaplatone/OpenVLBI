...
/**
* \brief Create an instance of the OpenVLBI server
* \return The newly created OpenVLBI server instance
*/
DLL_EXPORT vlbi_server_instance VLBI_Server_Create(void);

/**
* \brief Destroy a previously created OpenVLBI server instance
* \param instance A previously created OpenVLBI server instance
*/
DLL_EXPORT void VLBI_Server_Destroy(vlbi_server_instance);
...
*/
DLL_EXPORT int VLBI_Server_Init(vlbi_server_instance, int argc, char** argv);
...
*/
DLL_EXPORT void VLBI_Server_Parse(vlbi_server_instance);
...
*/
DLL_EXPORT void VLBI_Server_addModel(vlbi_server_instance, const char *name, char *format, char *b64);
...
*/
DLL_EXPORT dsp_stream_p VLBI_Server_getModel(vlbi_server_instance, const char *name);
...
*/
DLL_EXPORT char* VLBI_Server_getModelBase64(vlbi_server_instance, const char *name, char *format);

/**
* \brief delete from the current context an existing model by name.
* \param name The name of the model to be deleted
*/
DLL_EXPORT void VLBI_Server_delModel(vlbi_server_instance, const char *name);
...
*/
DLL_EXPORT int VLBI_Server_getModels(vlbi_server_instance, char** names);
...
* \param b64 The file buffer base64 encoded
*/
DLL_EXPORT void VLBI_Server_addNodeFromFits(vlbi_server_instance, const char *name, char *b64);
...
* \param b64 The file buffer base64 encoded
*/
DLL_EXPORT void VLBI_Server_addNodes(vlbi_server_instance, const char *name, char *b64);
...
*/
DLL_EXPORT void VLBI_Server_addNode(vlbi_server_instance, const char *name, dsp_location *locations, void *buf, int len, timespec starttime, bool geo);

/**
* \brief delete from the current context an existing node by name.
* \param name The name of the node to be deleted
*/
DLL_EXPORT void VLBI_Server_delNode(vlbi_server_instance, const char *name);
...
*/
DLL_EXPORT void VLBI_Server_CopyNode(vlbi_server_instance, const char *name, const char *node);
...
*/
DLL_EXPORT void VLBI_Server_Plot(vlbi_server_instance, const char *name, int flags);
...
*/
DLL_EXPORT void VLBI_Server_Idft(vlbi_server_instance, const char *name, const char *magnitude, const char *phase);
...
*/
DLL_EXPORT void VLBI_Server_Dft(vlbi_server_instance, const char *name, const char *magnitude, const char *phase);
...
*/
DLL_EXPORT void VLBI_Server_Mask(vlbi_server_instance, const char *name, const char *model, const char *mask);
...
*/
DLL_EXPORT void VLBI_Server_Stack(vlbi_server_instance, const char *name, const char *model1, const char *model2);
...
*/
DLL_EXPORT void VLBI_Server_Copy(vlbi_server_instance, const char *name, const char *model);
...
*/
DLL_EXPORT void VLBI_Server_Diff(vlbi_server_instance, const char *name, const char *model1, const char *model2);
...
*/
DLL_EXPORT void VLBI_Server_Convolve(vlbi_server_instance, const char *name, const char *model1, const char *model2);
...
*/
DLL_EXPORT void VLBI_Server_LowPass(vlbi_server_instance, const char *name, const char *node, double freq);
...
* \param freq The cutoff frequency in radians
*/
DLL_EXPORT void VLBI_Server_HighPass(vlbi_server_instance, const char *name, const char *node, double freq);
...
*/
DLL_EXPORT void VLBI_Server_BandPass(vlbi_server_instance, const char *name, const char *node, double lofreq, double hifreq);
...
* \param hifreq The high cut frequency in radians
*/
DLL_EXPORT void VLBI_Server_BandReject(vlbi_server_instance, const char *name, const char *node, double lofreq, double hifreq);

/**
* \brief Shift a model by its dimension in-place
* \param name The name of the model
*/
DLL_EXPORT void VLBI_Server_Shift(vlbi_server_instance, const char *name);

/**
* \brief set the target right ascension coordinate, do this before calling Plot()
* \param value The RA coordinate in hours
*/
DLL_EXPORT void VLBI_Server_setRa(vlbi_server_instance, double value);

/**
* \brief set the target declination coordinate, do this before calling Plot()
* \param value The Declination coordinate in degrees
*/
DLL_EXPORT void VLBI_Server_setDec(vlbi_server_instance, double value);

/**
* \brief set the frequency observed, do this before calling Plot()
* \param value The frequency in Hz
*/
DLL_EXPORT void VLBI_Server_setFreq(vlbi_server_instance, double value);

/**
* \brief set the sampling frequency, do this before calling Plot()
* \param value The sample rate, in samples per second
*/
DLL_EXPORT void VLBI_Server_setSampleRate(vlbi_server_instance, double value);

/**
* \brief set the bytes per sample, do this before calling addNode()
* \param value The word width in bytes
*/
DLL_EXPORT void VLBI_Server_setBps(vlbi_server_instance, int value);

/**
* \brief set the plot width, do this before calling Plot()
* \param value plot width in pixels
*/
DLL_EXPORT void VLBI_Server_setWidth(vlbi_server_instance, int value);

/**
* \brief set the plot height, do this before calling Plot()
* \param value plot height in pixels
*/
DLL_EXPORT void VLBI_Server_setHeight(vlbi_server_instance, int value);

/**
* \brief get the current right ascension coordinate
* \return The current right ascension in hours
*/
DLL_EXPORT double VLBI_Server_getRa(vlbi_server_instance);

/**
* \brief get the current declination coordinate
* \return The current declination in hours
*/
DLL_EXPORT double VLBI_Server_getDec(vlbi_server_instance);

/**
* \brief get the current frequency
* \return The frequency in Hz
*/
DLL_EXPORT double VLBI_Server_getFreq(vlbi_server_instance);

/**
* \brief get the current sample rate
* \return The sampling rate in sps
*/
DLL_EXPORT double VLBI_Server_getSampleRate(vlbi_server_instance);

/**
* \brief set the current correlation order
* \param order The correlation order
*/
DLL_EXPORT void VLBI_Server_setCorrelationOrder(vlbi_server_instance, int order);

/**
* \brief get the bytes per sample
* \return The word width in bytes
*/
DLL_EXPORT double VLBI_Server_getBps(vlbi_server_instance);

/**
* \brief get the plot width
* \return The plot width in pixels
*/
DLL_EXPORT double VLBI_Server_getWidth(vlbi_server_instance);

/**
* \brief get the plot height
* \return The plot height in pixels
*/
DLL_EXPORT double VLBI_Server_getHeight(vlbi_server_instance);

/**
* \brief set the input stream
* \param in The input stream file pointer
*/
DLL_EXPORT void VLBI_Server_setInput(vlbi_server_instance, FILE* in);

/**
* \brief get the input stream
* \return The input stream file pointer
*/
DLL_EXPORT FILE* VLBI_Server_getInput(vlbi_server_instance);

/**
* \brief set the output stream
* \param out The output stream file pointer
*/
DLL_EXPORT void VLBI_Server_setOutput(vlbi_server_instance, FILE* out);

/**
* \brief get the output stream
* \return The output stream file pointer
*/
DLL_EXPORT FILE* VLBI_Server_getOutput(vlbi_server_instance);

/**
* \brief set the delegate function
* \param func The new delegate
*/
DLL_EXPORT void VLBI_Server_setDelegate(vlbi_server_instance, vlbi_func2_t func);

/**
* \brief get the current delegate function
* \return The current delegate
*/
DLL_EXPORT vlbi_func2_t VLBI_Server_getDelegate(vlbi_server_instance);
